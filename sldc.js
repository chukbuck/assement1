...
const analysisOfRequirements = " The second step, where the requirements to complete the finished product are decided"
const design = "The second step, where the team (or individual) writes the code for the product"
const implementation = "The fourth step, code is put into use"
const testingAndIntegration = "The fifth step, code is checked for bugs"
const maintain = "The final step, code is continually maintained to check for bugs/add additional features"
